...
public class EngineTests
{
    ...
    { 
        var engine = Engine.Create("1.5 TSI EVO", FuelType.Create("Gasoline"), 150, 250, EngineEfficiency.LPer100Km(6.9m));
        ...
        engine.FuelType.Should().Be(FuelType.Create("Gasoline"));
